...
- Added benchmark graph image.
- Added redesigned public evidence board.
- Added proof-pack directory with machine-readable benchmark data, methodology, limitations, launch notes, and sanitized summaries.
